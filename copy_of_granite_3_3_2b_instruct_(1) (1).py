...
Original file is located at
    https://colab.research.google.com/drive/1XNCIUwsD9OOFzqPE71somVnN879_uovW
"""
...
class JSONRefinerCore:
    ...
    def to_pascalCase(text: str) -> str:
        ...
        camel = JSONRefinerCore.to_camelCase(text)
